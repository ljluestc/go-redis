...
type ClusterOptions struct {
	...
	// DisableAutoReload prevents automatic reloading of cluster state when using ForEachShard.
	// This can improve performance and prevent data races when cluster configuration rarely changes.
	// When enabled, you must manually call ReloadState when needed.
